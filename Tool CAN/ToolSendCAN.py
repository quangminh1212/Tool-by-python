...
def main():
    ...
    messages = [
        ...
        [0x07, 0x03, 0x62, 0x06, 0x01], # power             
        #I.Test GSM/GPS
        # 2. AT CMD
        ...
        [0x07, 0x10, 0x0f, 0x62, 0x06, 0x05, 0x20, 0x41],   # AT+CFUN=0
        [0x07, 0x21, 0x54, 0x2b, 0x43, 0x46, 0x55, 0x4e],  
        [0x07, 0x22, 0x3d, 0x30, 0x0d, 0x0a],        
        [0x07, 0x30, 0x55, 0x01],                  
        ...
        #4.read GPS cmd
        [0x07, 0x10, 0x18, 0x62, 0x06, 0x05, 0x13, 0x41],  # AT+QGPSGNMEA="GSV"
        [0x07, 0x21, 0x54, 0x2b, 0x51, 0x47, 0x50, 0x53],
        ...
        [0x07, 0x23, 0x45, 0x3d, 0x30, 0x0d, 0x0a, 0x0d],
        [0x07, 0x30, 0x55, 0x01],     
        ...
        [0x07, 0x10, 0x2c, 0x62, 0x06, 0x05, 0x28, 0x41],  # AT+QRXFTM="LTE BAND1",300,"ON",-90,1
        [0x07, 0x21, 0x54, 0x2B, 0x51, 0x52, 0x58, 0x46],
        [0x07, 0x22, 0x54, 0x4D, 0x3D, 0x22, 0x4C, 0x54],
        [0x07, 0x23, 0x45, 0x20, 0x42, 0x41, 0x4E, 0x44],
        [0x07, 0x24, 0x31, 0x22, 0x2C, 0x33, 0x30, 0x30],  
        [0x07, 0x25, 0x2C, 0x22, 0x4F, 0x4E, 0x22, 0x2C],  
        [0x07, 0x26, 0x2D, 0x39, 0x30, 0x2C, 0x31, 0x0D], 
        [0x07, 0x27, 0x0D, 0x0A],              
        [0x07, 0x30, 0x55, 0x01],  

        [0x07, 0x10, 0x2c, 0x62, 0x06, 0x05, 0x28, 0x41],  # AT+QRXFTM="LTE BAND3",1575,"ON",-97,1
        [0x07, 0x21, 0x54, 0x2B, 0x51, 0x52, 0x58, 0x46],
        [0x07, 0x22, 0x54, 0x4D, 0x3D, 0x22, 0x4C, 0x54],
        [0x07, 0x23, 0x45, 0x20, 0x42, 0x41, 0x4E, 0x44],
        [0x07, 0x24, 0x33, 0x22, 0x2C, 0x31, 0x35, 0x37],  
        [0x07, 0x25, 0x35, 0x2C, 0x22, 0x4F, 0x4E, 0x22],  
        [0x07, 0x26, 0x2C, 0x2D, 0x39, 0x37, 0x2C, 0x31], 
        [0x07, 0x27, 0x0D, 0x0D, 0x0A],              
        [0x07, 0x30, 0x55, 0x01],                 
    ]
